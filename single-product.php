        ...
        <div class="container">
            ...
            <div id="main-content" class="main-content">
                ...
                <div class="product-related-box single-layout">
                    ...
                    <?php while ($pros = mysqli_fetch_assoc($related_product)){?>
                        <li class="product-item">
                            <div class="contain-product layout-default">
                                <div class="product-thumb">
                                    <a href="single-product.php?status=singleProduct&&id=<?php echo
                                    $pros['pdt_id']; ?>" class="link-to-product">
                                        <img src="admin/upload/<?php echo $pros['pdt_image'];?>" alt="dd" width="270"
                                             height="270"
                                             class="product-thumnail">
                                    </a>
                                </div>
                                <div class="info">
                                    <b class="categories"><?php echo $pros['ctg_name'];?></b>
                                    <h4 class="product-title"><a href="single-product.php?status=singleProduct&&id=<?php echo
                                        $pros['pdt_id']; ?>" class="pr-name"><?php echo $pros['pdt_name'];
                                    ?></a></h4>
                                    <div class="price">
                                        <ins><span class="price-amount"><?php echo $pros['pdt_price'] ?></span></ins>
                                    </div>
                                    <div class="slide-down-box">
                                        ...
                                        <div class="buttons">
                                            ...
                                            <a href="single-product.php?status=singleProduct&&id=<?php echo
                                            $pros['pdt_id']; ?>" class="btn compare-btn"><i class="fa fa-random"
